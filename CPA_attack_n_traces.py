...
def run_CPA_n_traces(inputs_arr, total_ts, start_ts, trace_arr, nlow, nhigh, nincrement, save_folder, backup_interval):
    ...
    arr_max_overall = np.array([])
    arr_max_true_overall = np.array([])
    ...
    for i in range(num_of_traces_low, (num_of_traces_high + 1), increment):
        ...
        arr_max_overall = np.append(arr_max_overall, max_overall)
        arr_max_true_overall = np.append(arr_max_true_overall, max_true_overall)
        ...
        if completed % backup_interval == 0:
            np.save(save_folder + f'arr_max_overall_{nlow}_{i}_{nincrement}.npy', arr_max_overall)
            np.save(save_folder + f'arr_max_true_overall_{nlow}_{i}_{nincrement}.npy', arr_max_true_overall)
            np.save(save_folder + f'arr_max_sign_bit_{nlow}_{i}_{nincrement}.npy', arr_max_sign_bit)
            np.save(save_folder + f'arr_max_true_sign_bit_{nlow}_{i}_{nincrement}.npy', arr_max_true_sign_bit)
            np.save(save_folder + f'arr_max_exponent_bits_{nlow}_{i}_{nincrement}.npy', arr_max_exponent_bits)
            np.save(save_folder + f'arr_max_true_exponent_bits_{nlow}_{i}_{nincrement}.npy', arr_max_true_exponent_bits)
            np.save(save_folder + f'arr_max_byte_two_{nlow}_{i}_{nincrement}.npy', arr_max_byte_two)
            np.save(save_folder + f'arr_max_true_byte_two_{nlow}_{i}_{nincrement}.npy', arr_max_true_byte_two)
            np.save(save_folder + f'arr_max_byte_three_{nlow}_{i}_{nincrement}.npy', arr_max_byte_three)
            np.save(save_folder + f'arr_max_true_byte_three_{nlow}_{i}_{nincrement}.npy', arr_max_true_byte_three)
            np.save(save_folder + f'arr_max_byte_four_{nlow}_{i}_{nincrement}.npy', arr_max_byte_four)
            np.save(save_folder + f'arr_max_true_byte_four_{nlow}_{i}_{nincrement}.npy', arr_max_true_byte_four)
            np.save(save_folder + f'arr_num_traces_{nlow}_{i}_{nincrement}.npy', arr_num_traces)

    np.save(save_folder + f'final_arr_max_overall_{nlow}_{i}_{nincrement}.npy', arr_max_overall)
    np.save(save_folder + f'final_arr_max_true_overall_{nlow}_{i}_{nincrement}.npy', arr_max_true_overall)
    np.save(save_folder + f'final_arr_max_sign_bit_{nlow}_{i}_{nincrement}.npy', arr_max_sign_bit)
    np.save(save_folder + f'final_arr_max_true_sign_bit_{nlow}_{i}_{nincrement}.npy', arr_max_true_sign_bit)
    np.save(save_folder + f'final_arr_max_exponent_bits_{nlow}_{i}_{nincrement}.npy', arr_max_exponent_bits)
    np.save(save_folder + f'final_arr_max_true_exponent_bits_{nlow}_{i}_{nincrement}.npy', arr_max_true_exponent_bits)
    np.save(save_folder + f'final_arr_max_byte_two_{nlow}_{i}_{nincrement}.npy', arr_max_byte_two)
    np.save(save_folder + f'final_arr_max_true_byte_two_{nlow}_{i}_{nincrement}.npy', arr_max_true_byte_two)
    np.save(save_folder + f'final_arr_max_byte_three_{nlow}_{i}_{nincrement}.npy', arr_max_byte_three)
    np.save(save_folder + f'final_arr_max_true_byte_three_{nlow}_{i}_{nincrement}.npy', arr_max_true_byte_three)
    np.save(save_folder + f'final_arr_max_byte_four_{nlow}_{i}_{nincrement}.npy', arr_max_byte_four)
    np.save(save_folder + f'final_arr_max_true_byte_four_{nlow}_{i}_{nincrement}.npy', arr_max_true_byte_four)
    np.save(save_folder + f'final_arr_num_traces_{nlow}_{i}_{nincrement}.npy', arr_num_traces)

    print(arr_max_overall)
    print(arr_max_true_overall)
    print(arr_max_sign_bit)
    print(arr_max_true_sign_bit)
    print(arr_max_exponent_bits)
    print(arr_max_true_exponent_bits)
    print(arr_max_byte_two)
    print(arr_max_true_byte_two)
    print(arr_max_byte_three)
    print(arr_max_true_byte_three)
    print(arr_max_byte_four)
    print(arr_max_true_byte_four)
...
local_dir = "./txt_traces/project-protected-10k-decimate1_new_weights"
